...
public class Ex1 extends BaseTest2 {
    ...
    public void exerciseOneTest() {
        ...
        utilities.itemsAreInProperQuantityAndContainProperTexts(LocatorType.CSS, "header .nav>li",
        ...
        utilities.itemsAreInProperQuantityAndContainProperTexts(LocatorType.CSS,
        ...
        utilities.itemIsDisplayedAndHaveProperText(LocatorType.NAME, "jdi-text", "LOREM IPSUM DOLOR SIT AMET," +
        ...
        utilities.itemIsALinkWithProperURL(LocatorType.PARTIAL_LINK, "JDI GITHUB",
