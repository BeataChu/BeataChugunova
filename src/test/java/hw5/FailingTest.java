...
import hw5.enums.CaptionsUnderGreenPictures;
import hw5.enums.CenteredHeaders;
import hw5.enums.HeaderItems;
...
public class FailingTest extends BaseTest3 {


    @Feature("Homework 3 revised for Allure: Functionality of steps + page objects")
    @Story("Items and functions of a home page - failing test")
    @Test
    public void Ex1HW3Test() {
        ...
        homePageSteps.itemsAreInProperQuantity(Location.GREEN_PICTURES, 6);
